...
function massageData(data) {
  return data.entity.map(update => {
    ...
    let path1 = _getPath(lastStop, stop1, route_id);
    ...
    return {
      ...
      stop1,
      arrival1,
      departure1: departure1  || arrival1,
      path1,
      stop2,
      arrival2,
      departure2: departure2  || arrival2,
      path2,
      stop3,
      arrival3,
      departure3: departure3  || arrival3,
      path3
    };
  }).filter(data => data && data.stop1 && data.path1);
}
